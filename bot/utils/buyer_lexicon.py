...
start_message = OtherMsg(
    title_1="✨ Добро пожаловать в УслугиARBA! ✨\n\n"
...
next_start_msg = OtherMsg(
    title_1="🎯 В этом боте собраны специалисты Аргентины!\n\n"
...
food_type_menu = OtherMsg(
    ...
    buttons = [
        ("Готовая еда 🍱", "info_ready_made_food"),
        ("Мясные изделия 🥩", "info_meat_products"),
        ("Полуфабрикаты 🥟", "info_semi_finished"),
        ("Десерты и выпечка 🍰", "info_desserts_pastries"),
        ("Диетическая еда 🥗", "info_diet_food"),
        ("Консервация и соусы 🥫", "info_konc_sous_food"),
        ("Напитки 🥤", "info_drinks"),
        ("Назад ↩️", "back_main")
    ]
)

ready_made_food = OtherMsg(
    title_1 = "Отправляю 5 случайных карточек"
)

# Меню кнопки "По кухне"
to_kitchen_menu = OtherMsg(
    title_1 = "Выберите кухню",
    buttons = [
        ("Русская", "russian"),
...
""" ready_made_food_menu = OtherMsg(
    title_1 = "Нажмите для просмотра меню\n"
...
feedback_msg = OtherMsg(
    title_1 = "💬 Пожалуйста, опишите свою проблему подробно.\n"
...
feedback_call = OtherMsg(
    title_1 = "😊Мы всегда рады вашим отзывам и любой обратной связи!\n"
...
feedback_photo = OtherMsg(
    title_1 = "Сохранил, теперь отправьте фото",
    buttons=[
...
plug = OtherMsg(
    title_1 = "Бот работает в тестовом режиме.\n"
