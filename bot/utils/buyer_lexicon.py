...
start_message = OtherMsg(
    title="Пока сообщение отправляется всегда\n\n"

          '✨ Добро пожаловать в "УслугиARBA"! ✨\n\n'

          "Бот работает в тестовом режиме 🛠\n"
          "Мы создаем сообщество профессионалов Аргентины и проверяем работу сервиса."
          "Если заметили ошибки или есть идеи по улучшению - пишите нам через обратную связь ⬇️\n"
          "Сейчас работает только 1 категория - Еда на заказ!\n"
          ...
          "Там будут новости про обновления сервиса!",
          buttons=[
